...
/**
	The RoomProg class represents a single room program.
*/
public class RoomProg
{
	public int id;
	public String name = "";
	...
	public int run(Trigger tby, String args, Room loc, CharData mob, ObjData obj, CharData actor, CharData victim, int startAt, int ifLevel, int skippingFrom, HashMap<String, String> variables)
	{
		...
		for (String line : code)
		{
			...
			lineCtr++;
			String debug = "rprog #"+id+" at room #"+loc.id+", line "+lineCtr;
			...
			{
				updates.add(new Update(Fmt.getInt(Script.evalMath(arg1, debug)), this, null, null, tby,
	...
	public static RoomProg lookup(int targetId)
	{
